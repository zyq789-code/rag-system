    ...
    <div class="card p-4">
      <div class="flex items-center gap-4">
        <select
          ...
          class="border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-600 bg-gray-50 focus:bg-white focus:border-indigo-300 transition-colors min-w-[160px]"
        >
